...
class _CreatePostReplyPageState extends State<CreatePost> {
  ...
  void _submitButton() async {
    ...
    Post lastPost = await PostsRepo.getUserLastPost(Constants.currentUserID);
    ...
    await gamesRef
        .doc((await GamesRepo.getGameWithGameName(widget.selectedGame)).id)
          ...
          Padding(
            ...
            child: TypeAheadFormField(
              ...
              suggestionsCallback: (pattern) {
                return GamesRepo.searchGames(pattern.toLowerCase());
              },
