...
Widget customImage(
  ...
  return Container(
    ...
    child: CircleAvatar(
      ...
      backgroundImage:
          customAdvanceNetworkImage(path ?? Strings.default_profile_image),
    ),
  );
}
...
Widget customNetworkImage(String path, {BoxFit fit = BoxFit.contain}) {
  return CachedNetworkImage(
    fit: fit,
    imageUrl: path ?? Strings.default_profile_image,
...
dynamic customAdvanceNetworkImage(String path) {
  if (path == null) {
    path = Strings.default_profile_image;
  }
  ...
  return Container(
    ...
    child: Center(
      child: Stack(
        ...
        children: <Widget>[
          Container(
            width: Sizes.fullWidth(context) * .95,
            height: Sizes.fullHeight(context) * .95,
            decoration: BoxDecoration(
...
double getDimention(context, double unit) {
  if (Sizes.fullWidth(context) <= 360.0) {
    return unit / 1.3;
  } else {
    return unit;
  }
    ...
    child: Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Container(
            width: Sizes.fullWidth(context) - 80,
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                Row(
