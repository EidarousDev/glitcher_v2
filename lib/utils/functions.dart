...
cropImage(File imageFile) async {
  //File cropped = await ImageCropper.cropImage(sourcePath: imageFile.path, compressQuality: 50);
  //return cropped ?? imageFile; // Assign it later to File imageFile variable usign setState((){});.
  //TODO: Crop image
  return imageFile;
}
